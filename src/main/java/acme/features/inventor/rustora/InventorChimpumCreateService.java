...
//
//@Service
//public class InventorChimpumCreateService implements AbstractCreateService<Inventor, Rustora>{
//	
//	@Autowired
...
//
//	@Override
//	public Rustora instantiate(final Request<Rustora> request) {
//		assert request != null;
//		
//		Rustora res;
//		Date now;
...
//
//	@Override
//	public void create(final Request<Rustora> request, final Rustora entity) {
//		assert request != null;
//		assert entity != null;
//		Item item;
//		
